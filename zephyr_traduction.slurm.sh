#!/bin/bash
#SBATCH --job-name=zephyr_traduction         # Job name
#SBATCH --output=logs/log_zephyr_1.out          # Name of stdout output file. %x job_name, %j job_number
#SBATCH --error=logs/error_zephyr_1.err       # Name of stdout output file. %x job_name, %j job_number
...
python zephyr_traduction.py --input_path "dataset_cleaned.csv" --output_path "translated_dataset.csv"